    ...
    public String get(String url, Map<String, String> param) {
        ...
        try (Response response = client.newCall(request).execute()) {
            if (response.body() == null) {
                ...
                throw new JetException("okhttp get body null");
            }
            String result = response.body().string();
            if (!response.isSuccessful()) {
                log.error("get not success code:{} url:{} param:{} result:{}", response.code(), url, JSON.toJSONString(param), result);
                throw new JetException("okhttp get not success code:" + response.code());
            }
            ...
            throw new JetException("okhttp get error", e);
        }
    }
    ...
    public String postJson(String url, String body) {
        ...
        try (Response response = client.newCall(request).execute()) {
            if (response.body() == null) {
                ...
                throw new JetException("okhttp postJson body null");
            }
            String result = response.body().string();
            if (!response.isSuccessful()) {
                log.error("postJson not success code:{} url:{} param:{} result:{}", response.code(), url, body, result);
                throw new JetException("okhttp postJson not success code:" + response.code());
            }
            return result;
        } catch (JetException e) {
            throw e;
            ...
            throw new JetException("okhttp postJson error", e);
        }
    }
    ...
    public String postForm(String url, Map<String, String> param) {
        ...
        try (Response response = client.newCall(request).execute()) {
            if (response.body() == null) {
                ...
                throw new JetException("okhttp postForm body null");
            }
            String result = response.body().string();
            if (!response.isSuccessful()) {
                log.error("postForm not success code:{} url:{} param:{} result:{}", response.code(), url, JSON.toJSONString(param), result);
                throw new JetException("okhttp postForm not success code:" + response.code());
            }
            return result;
        } catch (JetException e) {
            throw e;
            ...
            throw new JetException("okhttp postForm error", e);
        }
    }
}
